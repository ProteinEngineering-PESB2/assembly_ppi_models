...
parser.add_argument("-g", "--group_id", help="Group ID to use as encoder property", choices=['Group_0','Group_1','Group_2','Group_3','Group_4','Group_5','Group_6','Group_7'], default='Group_0')
...
print("Start encoding with property: ", group_id)

response_encoding = encoding_dataset(dataset_encoders[group_id], dataset, dict_encoder)
...
command = "mkdir {}{}_{}\\{}".format(path_export, task_to_solve, combination_to_use, group_id)
os.system(command)
name_export = "{}{}_{}\\{}\\encoding_data.csv".format(path_export, task_to_solve, combination_to_use, group_id)
